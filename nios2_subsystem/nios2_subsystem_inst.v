	nios2_subsystem u0 (
		...
		.pio_vga_fifo_data_external_connection_export  (<connected-to-pio_vga_fifo_data_external_connection_export>),  //  pio_vga_fifo_data_external_connection.export
		.pio_vga_fifo_full_external_connection_export  (<connected-to-pio_vga_fifo_full_external_connection_export>),  //  pio_vga_fifo_full_external_connection.export
		.pio_vga_fifo_wrreq_external_connection_export (<connected-to-pio_vga_fifo_wrreq_external_connection_export>), // pio_vga_fifo_wrreq_external_connection.export
