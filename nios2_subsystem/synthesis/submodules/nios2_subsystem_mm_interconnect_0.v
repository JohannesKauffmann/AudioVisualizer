...
module nios2_subsystem_mm_interconnect_0 (
	...
	wire  [95:0] cmd_mux_001_src_data;                                                             // cmd_mux_001:src_data -> nios2_gen2_debug_mem_slave_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                            // nios2_gen2_debug_mem_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [7:0] cmd_mux_001_src_channel;                                                          // cmd_mux_001:src_channel -> nios2_gen2_debug_mem_slave_agent:cp_channel
	...
	wire  [95:0] cmd_mux_002_src_data;                                                             // cmd_mux_002:src_data -> onchip_memory2_s1_agent:cp_data
	...
	wire  [96:0] pio_fifo_q_s1_agent_rf_source_data;                                               // pio_fifo_q_s1_agent:rf_source_data -> pio_fifo_q_s1_agent_rsp_fifo:in_data
	...
	wire  [96:0] pio_fifo_q_s1_agent_rsp_fifo_out_data;                                            // pio_fifo_q_s1_agent_rsp_fifo:out_data -> pio_fifo_q_s1_agent:rf_sink_data
	...
	wire  [95:0] cmd_mux_003_src_data;                                                             // cmd_mux_003:src_data -> pio_fifo_q_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                            // pio_fifo_q_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [7:0] cmd_mux_003_src_channel;                                                          // cmd_mux_003:src_channel -> pio_fifo_q_s1_agent:cp_channel
	...
	wire  [96:0] pio_fifo_rdreq_s1_agent_rf_source_data;                                           // pio_fifo_rdreq_s1_agent:rf_source_data -> pio_fifo_rdreq_s1_agent_rsp_fifo:in_data
	...
	wire  [96:0] pio_fifo_rdreq_s1_agent_rsp_fifo_out_data;                                        // pio_fifo_rdreq_s1_agent_rsp_fifo:out_data -> pio_fifo_rdreq_s1_agent:rf_sink_data
	...
	wire  [95:0] cmd_mux_004_src_data;                                                             // cmd_mux_004:src_data -> pio_fifo_rdreq_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                            // pio_fifo_rdreq_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [7:0] cmd_mux_004_src_channel;                                                          // cmd_mux_004:src_channel -> pio_fifo_rdreq_s1_agent:cp_channel
	...
	wire  [96:0] pio_fifo_rdfull_s1_agent_rf_source_data;                                          // pio_fifo_rdfull_s1_agent:rf_source_data -> pio_fifo_rdfull_s1_agent_rsp_fifo:in_data
	...
	wire  [96:0] pio_fifo_rdfull_s1_agent_rsp_fifo_out_data;                                       // pio_fifo_rdfull_s1_agent_rsp_fifo:out_data -> pio_fifo_rdfull_s1_agent:rf_sink_data
	...
	wire  [95:0] cmd_mux_005_src_data;                                                             // cmd_mux_005:src_data -> pio_fifo_rdfull_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                            // pio_fifo_rdfull_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [7:0] cmd_mux_005_src_channel;                                                          // cmd_mux_005:src_channel -> pio_fifo_rdfull_s1_agent:cp_channel
	...
	wire  [96:0] pio_fifo_rdempty_s1_agent_rf_source_data;                                         // pio_fifo_rdempty_s1_agent:rf_source_data -> pio_fifo_rdempty_s1_agent_rsp_fifo:in_data
	...
	wire  [96:0] pio_fifo_rdempty_s1_agent_rsp_fifo_out_data;                                      // pio_fifo_rdempty_s1_agent_rsp_fifo:out_data -> pio_fifo_rdempty_s1_agent:rf_sink_data
	...
	wire  [95:0] cmd_mux_006_src_data;                                                             // cmd_mux_006:src_data -> pio_fifo_rdempty_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                            // pio_fifo_rdempty_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [7:0] cmd_mux_006_src_channel;                                                          // cmd_mux_006:src_channel -> pio_fifo_rdempty_s1_agent:cp_channel
	...
	wire  [96:0] pio_data_back_s1_agent_rf_source_data;                                            // pio_data_back_s1_agent:rf_source_data -> pio_data_back_s1_agent_rsp_fifo:in_data
	...
	wire  [96:0] pio_data_back_s1_agent_rsp_fifo_out_data;                                         // pio_data_back_s1_agent_rsp_fifo:out_data -> pio_data_back_s1_agent:rf_sink_data
	...
	wire  [95:0] cmd_mux_007_src_data;                                                             // cmd_mux_007:src_data -> pio_data_back_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                            // pio_data_back_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [7:0] cmd_mux_007_src_channel;                                                          // cmd_mux_007:src_channel -> pio_data_back_s1_agent:cp_channel
	...
	wire  [95:0] nios2_gen2_debug_mem_slave_agent_rp_data;                                         // nios2_gen2_debug_mem_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [95:0] onchip_memory2_s1_agent_rp_data;                                                  // onchip_memory2_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [95:0] pio_fifo_q_s1_agent_rp_data;                                                      // pio_fifo_q_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [95:0] pio_fifo_rdreq_s1_agent_rp_data;                                                  // pio_fifo_rdreq_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [95:0] pio_fifo_rdfull_s1_agent_rp_data;                                                 // pio_fifo_rdfull_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [95:0] pio_fifo_rdempty_s1_agent_rp_data;                                                // pio_fifo_rdempty_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [95:0] pio_data_back_s1_agent_rp_data;                                                   // pio_data_back_s1_agent:rp_data -> router_009:sink_data
	...
	nios2_subsystem_mm_interconnect_0_router router_001 (
	...
	nios2_subsystem_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_50_clk_clk),                                              //        clk.clk
		.reset              (nios2_gen2_reset_reset_bridge_in_reset_reset),                //  clk_reset.reset
	...
	nios2_subsystem_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_50_clk_clk),                               //       clk.clk
		.reset               (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
